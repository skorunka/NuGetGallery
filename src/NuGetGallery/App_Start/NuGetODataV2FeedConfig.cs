...
namespace NuGetGallery
{
    public static class NuGetODataV2FeedConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            // Add OData routes
            config.Routes.MapODataServiceRoute("api-vX", "api/vX", model, new CountODataPathHandler(), conventions, new DefaultODataBatchHandler(GlobalConfiguration.DefaultServer));
        }
